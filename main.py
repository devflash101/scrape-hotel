...
with open('txt/column_a-1.txt', 'w', encoding='utf-8') as f_a:
    for item in column_a:
        f_a.write(f"{item}\n")

# Write column_b to a text file
with open('txt/column_b-1.txt', 'w', encoding='utf-8') as f_b:
    for item in column_b:
        f_b.write(f"{item}\n")

# Write column_c to a text file
with open('txt/column_c-1.txt', 'w', encoding='utf-8') as f_c:
